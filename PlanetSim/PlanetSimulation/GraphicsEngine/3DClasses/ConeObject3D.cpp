...
// Jak Tiano, 2014
//
// Builds vertex/index buffer for a cone based on height/radius/facets input
//=============================================================================
...
#include <math.h>
//=============================================================================
ConeObject3D::ConeObject3D( float height, float radius, int sideFacetsNum, int heightFacetsNum )
{
	m_height = height;
	m_radius = radius;
...
void ConeObject3D::Create( IDirect3DDevice9* gd3dDevice )
{
	...
	HR(D3DXCreateCylinder(gd3dDevice, m_radius, 0, m_height, m_sideFacetsNum, m_heightFacetsNum, &m_Mesh, NULL));
...
void ConeObject3D::generateTextureCoordinates()
{
	// clone mesh 
